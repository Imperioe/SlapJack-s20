...
public class FrameworkTests {
    ...
    public void test_createLocalGame(){
        ...
        LocalGame localGame = activity.createLocalGame(new SJState());
    ...
    public void test_saveConfigButton(){
        ...
        //TODO: Change to your game Main Activity
        SJMainActivity reloadActivity = Robolectric.buildActivity(SJMainActivity.class).create().resume().get();
    ...
    public void test_save_game() {
        ...
        Saving.writeToFile(sjState, R.string.app_name + "_test", activity);

        //Test by remaking the state
        //TODO: Change to your game State
        SJState newState = new SJState((SJState) Saving.readFromFile(R.string.app_name + "_test", activity));

        //Check the game states are the same
        assertTrue(sjState.equals(newState));
    }
